...
AudioLDM2 DDIM reversibility report
{
  ...
  "ddim_inversion_x1_prime_vs_sender_x1": {
    ...
    "max_abs": 0.038286544382572174,
    "mean_abs": 0.003548234235495329,
    "rmse": 0.004564326722174883
  },
  "ddim_inversion_x2_prime_vs_sender_x2": {
    ...
    "max_abs": 0.4115253984928131,
    "mean_abs": 0.050311751663684845,
    "rmse": 0.06380467116832733
  },
  "zs_prime_vs_sender_zs": {
    ...
    "max_abs": 23.409420013427734,
    "mean_abs": 0.46073830127716064,
    "rmse": 1.1472017765045166
  },
  "zs_from_replayed_x2_and_inverted_x1_vs_sender_zs": {
    ...
    "max_abs": 0.698366105556488,
    "mean_abs": 0.06472160667181015,
    "rmse": 0.08325564861297607
  },
  "sender_zs_vs_sender_e_t": {
    ...
    "max_abs": 4.328787326812744e-06,
    "mean_abs": 5.16209638590226e-07,
    "rmse": 7.942214210743259e-07
  },
  "x0_self_check": {
    "shape": [
      1,
  ...
  "bit_embedding_experiment": {
    ...
    "embedded_zs_recovered_zs_diff": {
      ...
      "max_abs": 0.859480082988739,
      "mean_abs": 0.0363381989300251,
      "rmse": 0.054547205567359924
    },
    "stego_x1_recovered_x1_diff": {
      ...
      "max_abs": 0.04711925983428955,
      "mean_abs": 0.0019921609200537205,
      "rmse": 0.0029904362745583057
    }
  },
  "audio_roundtrip_extraction": {
    ...
    "bits_per_z": 1,
    "num_bits": 32768,
    "bit_accuracy": 0.509918212890625,
    "bit_error_rate": 0.490081787109375,
    "symbol_accuracy": 0.509918212890625,
    "symbol_error_rate": 0.490081787109375,
    "bit_errors": 16059,
    "symbol_errors": 16059,
    "stego_wav_path": "/home/ZhangYifan/ldm-stegan/AudioLDM2/tools/outputs_v4/stego_bits_1b.wav",
    ...
    "audio_x0_prime_vs_stego_x0": {
      ...
      "max_abs": 1.5057799816131592,
      "mean_abs": 0.13867586851119995,
      "rmse": 0.19291631877422333
    },
    "audio_x1_prime_vs_stego_x1": {
      ...
      "max_abs": 1.5253374576568604,
      "mean_abs": 0.14933069050312042,
      "rmse": 0.20373141765594482
    },
    "audio_recovered_zs_vs_embedded_zs": {
      ...
      "max_abs": 27.822935104370117,
      "mean_abs": 2.723867893218994,
      "rmse": 3.716165065765381
    }
  }
}
Saved traced tensors to outputs_v4/ddim_bits_1b.pt """
...
def run_audio_roundtrip_extraction(
    ...
    audio_x0_prime, fbank = wav_path_to_x0(
        model,
        stego_wav_path,
        model_name,
        duration,
        ...
        torch.save(
            {
                ...
                if audio_roundtrip is None
                    ...
                    "fbank": audio_roundtrip["fbank"].cpu(),
                },
            },
            args.save_pt,
        )
