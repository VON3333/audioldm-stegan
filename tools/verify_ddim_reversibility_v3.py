""" 嵌入秘密信息并生成完整音频文件outputs
Save audio to /home/ZhangYifan/ldm-stegan/AudioLDM2/tools/outputs/cover.wav
Save audio to /home/ZhangYifan/ldm-stegan/AudioLDM2/tools/outputs/stego_bits_1b.wav
...
Saved traced tensors to outputs/ddim_bits_1b.pt """
...
from audioldm2.utils import save_wave
...
def main():
    ...
    if args.save_stego_wav:
        ...
        save_waveform_file(model, bit_experiment["stego_x0"], args.save_stego_wav)
