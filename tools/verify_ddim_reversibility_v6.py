...
这里只比较了x0的结果，后面比较vae后的结果要看/home/ZhangYifan/ldm-stegan/AudioLDM2/tools/ablate_vae_roundtrip_full_v2.py

CUDA_VISIBLE_DEVICES=7 python verify_ddim_reversibility.py --model_name audioldm2-speech-ljspeech -t "A female reporter is speaking full of emotion" --transcription "Wish you have a good day" --ddim_steps 100 --ddim_eta 0 --guidance_scale 3.5 --seed 0 --bits_per_z 1 --repeat_k 31 --interleave_repetition --message_seed 1234 --save_pt outputs_v6/ddim_bits_1b_repeat31.pt

The future belongs to those who believe in the beauty of their dreams. Stay curious, keep learning, and never stop exploring the world around you.
...
AudioLDM2 DDIM reversibility report
{
  ...
  "ddim_inversion_x1_prime_vs_sender_x1": {
    ...
    "max_abs": 0.03859076648950577,
    "mean_abs": 0.003549097804352641,
    "rmse": 0.004565603099763393
  },
  "ddim_inversion_x2_prime_vs_sender_x2": {
    ...
    "max_abs": 0.41230130195617676,
    "mean_abs": 0.0503176748752594,
    "rmse": 0.06381111592054367
  },
  "zs_prime_vs_sender_zs": {
    ...
    "max_abs": 23.464595794677734,
    "mean_abs": 0.46103495359420776,
    "rmse": 1.1481956243515015
  },
  "zs_from_replayed_x2_and_inverted_x1_vs_sender_zs": {
    ...
    "max_abs": 0.7039152979850769,
    "mean_abs": 0.06473734974861145,
    "rmse": 0.08327893912792206
  },
  "sender_zs_vs_sender_e_t": {
    ...
    "max_abs": 4.32133674621582e-06,
    "mean_abs": 5.129767828293552e-07,
    "rmse": 7.896161378084798e-07
  },
  "x0_self_check": {
    "shape": [
      1,
  ...
  "bit_embedding_experiment": {
    ...
    "bits_per_z": 1,
    "num_bits": 32768,
    "bit_accuracy": 0.99969482421875,
    "bit_error_rate": 0.00030517578125,
    "symbol_accuracy": 0.99969482421875,
    "symbol_error_rate": 0.00030517578125,
    "bit_errors": 10,
    "symbol_errors": 10,
    "repeat_k": 31,
    "message_bits": 1057,
    ...
    "voted_bit_accuracy": 1.0,
    "voted_bit_error_rate": 0.0,
    "voted_bit_errors": 0,
    "embedded_zs_recovered_zs_diff": {
      ...
      "max_abs": 1.0186750888824463,
      "mean_abs": 0.03641242906451225,
      "rmse": 0.056541528552770615
    },
    "stego_x1_recovered_x1_diff": {
      ...
      "max_abs": 0.05584681034088135,
      "mean_abs": 0.00199623079970479,
      "rmse": 0.0030997709836810827
    }
  }
}
Saved traced tensors to outputs_v6/ddim_bits_1b_repeat31.pt

CUDA_VISIBLE_DEVICES=7 python verify_ddim_reversibility.py --model_name audioldm2-speech-ljspeech -t "A female reporter is speaking full of emotion" --transcription "Wish you have a good day" --ddim_steps 100 --ddim_eta 0 --guidance_scale 3.5 --seed 0 --bits_per_z 1 --repeat_k 63 --interleave_repetition --message_seed 1234 --save_pt outputs_v6/ddim_bits_1b_repeat63.pt --save_cover_wav outputs/cover.wav --save_stego_wav outputs/stego_repeat63.wav
...
def random_interleaved_repetition_bits_to_gaussian_midpoints(
    shape, bits_per_z, repeat_k, seed, device
):
    if bits_per_z != 1:
...
def run_bit_embedding_experiment(
    ...
    if interleave_repetition or repeat_k > 1:
        repetition = random_interleaved_repetition_bits_to_gaussian_midpoints(
            shape, bits_per_z, repeat_k, message_seed, device
        )
        bits = repetition["bits"]
        symbols = repetition["symbols"]
        embedded_zs = repetition["embedded_zs"]
    else:
    ...
    if repetition is not None:
        voted_message_bits, vote_metrics = repetition_vote_metrics(
            repetition["message_bits"], decoded_bits, repetition["grouped_positions"]
        )
        ...
        result.update(
            {
                ...
                "grouped_positions": repetition["grouped_positions"],
