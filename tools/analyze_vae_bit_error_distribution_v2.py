...
def load_pair(vae_pt, input_pt=None):
    ...
    return input_pt, bits, decoded_bits, z, embedded_z, used_positions, exclude_channels
...
def make_bit_comparison_rows(bits, decoded_bits, z, embedded_z, used_positions, limit=None):
...
def make_error_only_rows(bits, decoded_bits, z, embedded_z, used_positions, limit=None):
    rows = make_bit_comparison_rows(bits, decoded_bits, z, embedded_z, used_positions, limit=None)
...
def main():
    ...
    input_pt, bits, decoded_bits, z, embedded_z, used_positions, exclude_channels = load_pair(
        args.vae_pt, args.input_pt
    )
