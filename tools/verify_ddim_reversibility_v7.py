...
CUDA_VISIBLE_DEVICES=7 python verify_ddim_reversibility.py --model_name audioldm2-speech-ljspeech -t "A female reporter is speaking full of emotion" --transcription "The future belongs to those who believe in the beauty of their dreams. Stay curious, keep learning, and never stop exploring the world around you." --ddim_steps 100 --ddim_eta 0 --guidance_scale 3.5 --seed 0 --bits_per_z 1 --repeat_k 1 --interleave_repetition --message_seed 1234 --save_pt outputs_v7/ddim_bits_1b_10s.pt
